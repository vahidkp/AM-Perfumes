  ...
  return (
    <div className="border-y border-gold/25 bg-cream">
      <div className="mx-auto max-w-content px-6 py-5 md:px-12">
        <div className="grid grid-cols-1 gap-x-5 gap-y-5 sm:grid-cols-2 md:grid-cols-4">
          {items.map(({ Icon, text }) => (
            <div key={text} className="flex items-center justify-start gap-3 md:justify-center">
